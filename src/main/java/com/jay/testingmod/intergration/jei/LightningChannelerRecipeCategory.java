...
public class LightningChannelerRecipeCategory implements IRecipeCategory<LightningChannelerRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(TestingMod.MOD_ID, "lightning");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(TestingMod.MOD_ID, "textures/gui/lightning_channeler_gui.png");
    ...
    public String getTitle() {
        return ModBlocks.LIGHTNING_CHANNELER.get().getTranslatedName().toString();
    }
