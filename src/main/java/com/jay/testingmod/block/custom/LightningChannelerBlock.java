...
import com.jay.testingmod.container.LightningChannelerContainer;
import com.jay.testingmod.tileentity.LightningChannelerTile;
...
public class LightningChannelerBlock extends Block {
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.testingmod.lightning_channeler");
            }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntity.LIGHTNING_CHANNELER_TILE.get().create();
    }
