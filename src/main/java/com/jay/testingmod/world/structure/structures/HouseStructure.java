package com.jay.testingmod.world.structure.structures;
...
public class HouseStructure extends Structure<NoFeatureConfig> {
    ...
    protected boolean func_230363_a_(ChunkGenerator chunkGenerator, BiomeProvider biomeProvider,
        ...
        IBlockReader columnOfBlock = chunkGenerator.func_230348_a_(centerOfChunk.getX(), centerOfChunk.getZ());
        BlockState topBlock = columnOfBlock.getBlockState(centerOfChunk.up(landHeight));
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(TestingMod.MOD_ID, "house/start_pool")),
