package com.jay.testingmod.world.structure;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;
import com.jay.testingmod.TestingMod;
import com.jay.testingmod.world.structure.structures.HouseStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, TestingMod.MOD_ID);
    ...
    public static void setStructures() {
        setupMapSpaceingAndLand(HOUSE.get(),
     ...
     * this method in the structureSeparetionSettings argument.
     * This method is called by setupStructures above.
     **/
     public static <F extends Structure<?>> void setupMapSpaceingAndLand(F structure, StructureSeparationSettings structureSeparationSettings,
         ...
         *
         * DEFAULTS requites AccessTransformer (See resources/META-INF/accesstransforms.cfg)
          */
         ...
         * NOISE_GENERATE_SETTINGS loop below but that field only applies for the default overworld and
         * won't add to other worldtypes or dimenstions (like amplified or Nether).
         ...
         * below instead if you must
         ...
         WorldGenRegistries.NOISE_SETTINGS.getEntries().forEach(settings -> {
             ...
             * I take no chances myself. You never know that another mod does...
             *
             * structureConfig requites AccessTransformer (See resources/META-INF/accesstranformer.cfg)
              */
